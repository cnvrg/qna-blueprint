...
class ModelArguments:
    ...
    tokenizer_name_or_path: Optional[str] = field(
        default="/input/prepare/t5_qg_tokenizer",
...
class DataTrainingArguments:
    ...
    train_file_path: str = field(
        default="/input/prepare/train_data_qg_hl_t5.pt",
    ...
    valid_file_path: str = field(
        default="/input/prepare/valid_data_qg_hl_t5.pt",
...
class TrainArguments:
    ...
    output_dir: str = field(
        default=cnvrg_workdir+"/t5-small-qg-hl",
        metadata={"help": "Path for trained model"},
    )
    overwrite_output_dir: str = field(
        default=False,
    )
    do_train: Optional[str] = field(
        default=False, 
    )
    do_eval: Optional[str] = field(
        default=False, 
    )
    do_predict: Optional[str] = field(
        default=False, 
    )
    evaluate_during_training: Optional[str] = field(
        default=False, 
    )
    per_device_train_batch_size: Optional[str] = field(
        default=8, 
    )
    per_device_eval_batch_size: Optional[str] = field(
        default=8, 
    )
    per_gpu_train_batch_size: Optional[str] = field(
        default=None, 
    )
    per_gpu_eval_batch_size: Optional[str] = field(
        default=None, 
    )
    gradient_accumulation_steps: Optional[str] = field(
        default=1, 
    )
    learning_rate: Optional[str] = field(
        default=5e-05, 
    )
    weight_decay: Optional[str] = field(
        default=0.0, 
    )
    adam_epsilon: Optional[str] = field(
        default=1e-08, 
    )
    max_grad_norm: Optional[str] = field(
        default=1.0, 
    )
    num_train_epochs: Optional[str] = field(
        default=10, 
    )
    max_steps: Optional[str] = field(
        default=-1, 
    )
    warmup_steps: Optional[str] = field(
        default=0, 
    )
    logging_first_step: Optional[str] = field(
        default=False, 
    )    
    logging_steps: Optional[str] = field(
        default=500, 
    )    
    save_steps: Optional[str] = field(
        default=500, 
    )    
    save_total_limit: Optional[str] = field(
        default=None, 
    )
    no_cuda: Optional[str] = field(
        default=False, 
    )
    seed: Optional[str] = field(
        default=42, 
    )    
    f16: Optional[str] = field(
        default=False, 
    )
    f16_opt_level: Optional[str] = field(
        default='O1', 
    )
    local_rank: Optional[str] = field(
        default=-1, 
    )
    tpu_num_cores: Optional[str] = field(
        default=None, 
    )
    tpu_metrics_debug: Optional[str] = field(
        default=False, 
    )
    dataloader_drop_last: Optional[str] = field(
        default=False, 
    )
